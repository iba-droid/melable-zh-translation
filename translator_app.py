...
TONE_GUIDE = {
    "강하게": "인플루언서 구어체 최대. 竟然/真的/超/太/哇 등 감탄사 적극 사용. 흥분되고 친근한 톤.",
    "보통":   "자연스러운 구어체. 적당한 감탄 표현. 읽기 편하고 공감되는 톤.",
    "살짝만": "구어체이되 감탄사 자제. 신뢰감 있고 부드러운 톤.",
}
LENGTH_GUIDE = {
...
with tab_trans:
    ...
    with c4:
        tone_level = st.selectbox("톤 강도", ["보통","강하게","살짝만"],
                                  help="강하게: 감탄사 풀가동\n보통: 자연스러운 구어체\n살짝만: 차분한 톤")
    with c5:
